...
{
    public partial class AccountTypeInsertUpdate : Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SP_AccountTypeInsertUpdate", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@AccountTypeName", txtAccountTypeName.Text.Trim());
