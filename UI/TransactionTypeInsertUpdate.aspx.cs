...
{
    public partial class TransactionTypeInsertUpdate : Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SP_TransactionTypeInsertUpdate", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@TransactionTypeName", ddlTransactionTypeName.SelectedValue);
        ...
        {
            ddlTransactionTypeName.SelectedIndex = 0;
