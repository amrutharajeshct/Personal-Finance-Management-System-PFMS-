<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentMethodInsertUpdate.aspx.cs" Inherits="FinanceApp.PaymentMethodInsertUpdate" %>
<!DOCTYPE html>
<html>
<head runat="server">
    ...
    <style>
        ...
        input[type=text], textarea { width: 100%; padding: 9px 10px; border: 1px solid #cbd2d9; border-radius: 5px;
...
<body>
    <form id="form1" runat="server">
        <div class="card">
            ...
            <div class="field">
                <label for="txtPaymentMethodName">Payment Method Name</label>
                <asp:TextBox ID="txtPaymentMethodName" runat="server" MaxLength="50" placeholder="e.g. UPI" />
                <div class="hint">Typically: Cash, UPI, Debit Card, Bank Transfer (BR-021)</div>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPaymentMethodName"
                    ErrorMessage="Payment method name is required." CssClass="validator" Display="Dynamic" />
            </div>
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save Payment Method" CssClass="btn" OnClick="btnSave_Click" />
