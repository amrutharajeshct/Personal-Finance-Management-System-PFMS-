<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountTypeInsertUpdate.aspx.cs" Inherits="FinanceApp.AccountTypeInsertUpdate" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body>
    <form id="form1" runat="server">
        <div class="card">
            ...
            <div class="field">
                <label for="txtAccountTypeName">Account Type Name</label>
                <asp:TextBox ID="txtAccountTypeName" runat="server" MaxLength="50" placeholder="e.g. Savings, Wallet, Credit Card" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtAccountTypeName"
                    ErrorMessage="Account type name is required." CssClass="validator" Display="Dynamic" />
            </div>
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save Account Type" CssClass="btn" OnClick="btnSave_Click" />
